...
public class FDLOperationsImpl extends ASTWrapperPsiElement implements FDLOperations {

  public FDLOperationsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FDLVisitor visitor) {
    visitor.visitOperations(this);
  }
